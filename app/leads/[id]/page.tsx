...
const sampleLeads: Record<string, Lead> = {
  '1': {
    ...
    notes: [
      { author: 'Sales Team', date: '2024-02-16', text: 'Very responsive customer' },
    ],
  },
  '2': {
    id: 2,
...
export default function LeadDetailPage({
  ...
  useEffect(() => {
    ...
    const allLeads = [...stored, ...Object.values(sampleLeads)]

    const found = allLeads.find((l) => String(l.id) === id)
...
//             <span className={`px-3 py-1 rounded-full text-sm border ${getStatusColor(lead.status)}`}>
//               {lead.status}
//             </span>
//           </div>
